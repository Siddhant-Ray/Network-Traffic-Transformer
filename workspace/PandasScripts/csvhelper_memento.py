...
def generate_senders_csv(path, n_senders):
    ...
    files = ["large_test_disturbance_with_message_ids1.csv", "large_test_disturbance_with_message_ids2.csv", "large_test_disturbance_with_message_ids3.csv",
             "large_test_disturbance_with_message_ids4.csv", "large_test_disturbance_with_message_ids5.csv", "large_test_disturbance_with_message_ids6.csv",
             "large_test_disturbance_with_message_ids7.csv", "large_test_disturbance_with_message_ids8.csv", "large_test_disturbance_with_message_ids9.csv",
