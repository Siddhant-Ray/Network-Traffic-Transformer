...
train_loss_epoch_df_pretrained0 = df_pretrained0[
    df_pretrained0["tag"] == "Avg loss per epoch"
]
...
train_loss_epoch_df_pretrained1 = df_pretrained1[
    df_pretrained1["tag"] == "Avg loss per epoch"
]
...
train_loss_epoch_df_pretrained2 = df_pretrained2[
    df_pretrained2["tag"] == "Avg loss per epoch"
]
...
t0 = sns.lineplot(
    x=train_loss_epoch_df_pretrained0.index,
    y="value",
    data=train_loss_epoch_df_pretrained0,
    color="blue",
    label="Fixed Mask Last",
    ax=ax[0],
)
t1 = sns.lineplot(
    x=train_loss_epoch_df_pretrained1.index,
    y="value",
    data=train_loss_epoch_df_pretrained1,
    color="green",
    label="Last 16",
    ax=ax[0],
)
t2 = sns.lineplot(
    x=train_loss_epoch_df_pretrained2.index,
    y="value",
    data=train_loss_epoch_df_pretrained2,
    color="red",
    label="Last 32",
    ax=ax[0],
)
...
v0 = sns.lineplot(
    x=val_loss_epoch_df_pretrained0.index,
    y="value",
    data=val_loss_epoch_df_pretrained0,
    color="blue",
    label="Fixed Mask Last",
    ax=ax[1],
)
v1 = sns.lineplot(
    x=val_loss_epoch_df_pretrained1.index,
    y="value",
    data=val_loss_epoch_df_pretrained1,
    color="green",
    label="Last 16",
    ax=ax[1],
)
v2 = sns.lineplot(
    x=val_loss_epoch_df_pretrained2.index,
    y="value",
    data=val_loss_epoch_df_pretrained2,
    color="red",
    label="Last 32",
    ax=ax[1],
)
...
fig.legend(
    ["Fixed Mask Last", "Last 16", "Last 32"],
    loc="upper right",
    bbox_to_anchor=(0.968, 0.958),
    ncol=1,
    fontsize=10,
)
...
train_loss_epoch_df_pretrained3 = df_pretrained3[
    df_pretrained3["tag"] == "Avg loss per epoch"
]
...
train_loss_epoch_df_pretrained4 = df_pretrained4[
    df_pretrained4["tag"] == "Avg loss per epoch"
]
...
train_loss_epoch_df_pretrained5 = df_pretrained5[
    df_pretrained5["tag"] == "Avg loss per epoch"
]
...
t1 = sns.lineplot(
    x=train_loss_epoch_df_pretrained4.index,
    y="value",
    data=train_loss_epoch_df_pretrained4,
    color="green",
    label="Choose Enc. State",
    ax=ax[0],
)
t2 = sns.lineplot(
    x=train_loss_epoch_df_pretrained3.index,
    y="value",
    data=train_loss_epoch_df_pretrained3,
    color="red",
    label="Choose Agg. Level",
    ax=ax[0],
)
...
v1 = sns.lineplot(
    x=val_loss_epoch_df_pretrained4.index,
    y="value",
    data=val_loss_epoch_df_pretrained4,
    color="green",
    label="Choose Enc. State",
    ax=ax[1],
)
v2 = sns.lineplot(
    x=val_loss_epoch_df_pretrained3.index,
    y="value",
    data=val_loss_epoch_df_pretrained3,
    color="red",
    label="Choose Agg. Level",
    ax=ax[1],
)
...
# Make legend
fig.legend(
    ["Fixed Mask Last", "Choose Enc. State", "Choose Agg. Level"],
    loc="upper right",
    bbox_to_anchor=(0.968, 0.958),
    ncol=1,
    fontsize=10,
